...
export class PlaceholderPipe implements PipeTransform {
  transform(context: ICERequestContext, formControlName: string, emtpyPlaceholderString?: string, debug?: boolean): string {
    if (debug) {
  ...
  getPlaceholderFromConfig(context: ICERequestContext, formControlName: string, emtpyPlaceholderString?: string): string {
    return (context &&
