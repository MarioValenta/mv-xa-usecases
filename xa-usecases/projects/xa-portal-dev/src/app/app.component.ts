...
import * as Payload from '../../../@vmcreate/request-form/mocks/Payload.json';
import * as ConfigPayload from '../../../@vmcreate/request-form/mocks/ConfigPayload.json';
import * as Validation from '../../../@vmcreate/request-form/mocks/Validation.json';
