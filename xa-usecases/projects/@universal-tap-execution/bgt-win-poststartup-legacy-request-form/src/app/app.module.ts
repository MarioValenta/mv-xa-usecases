...
export class UniversalTapExecutionBGTWinPoststartupLegacyRequestFormAppModule {

  constructor(private injector: Injector) { }

  ngDoBootstrap() {
    const ce = createCustomElement(AppComponent, { injector: this.injector });
    customElements.define('universal-tap-execution-bgt-win-poststartup-legacy-request-form', ce);
  }
}
