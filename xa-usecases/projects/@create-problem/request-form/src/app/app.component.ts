...
@Component({
  selector: 'create-problem-request-form',
  ...
  customerSelected() {
    this.form
      .get('Customer')?.setValue(
        this.getSelectedCustomerBySM9name(this.form.get('CustomerName')?.value) ?
          this.getSelectedCustomerBySM9name(this.form.get('CustomerName')?.value).label : null
      );
  }
