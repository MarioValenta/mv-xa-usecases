...
export class AppComponent implements OnInit, OnDestroy, ICERequest {
  ...
  @ViewChild('CPUs') public cpuSlider: NouisliderComponent;
  @ViewChild('RAM') public ramSlider: NouisliderComponent;
  ...
  Hostname$: BehaviorSubject<string> = new BehaviorSubject(null);
